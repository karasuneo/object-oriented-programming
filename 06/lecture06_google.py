...
# 編集した画像を保存する
cv2.imwrite('./img/google_change_color.png', img)
...
# 編集した画像を保存する
cv2.imwrite('./img/google_with_rectangle.png', img)
...
# 編集した画像を保存する
cv2.imwrite('./img/google_250x200.png',part_img)
...
# 編集した画像を保存する
cv2.imwrite('./img/new_img_750x400.png',new_img)
...
cv2.imwrite('./img/img_modified.png', img)